...
using Exemplo_Web_API_Authentication.Models;
using Exemplo_Web_API_Authentication.Providers;
using Exemplo_Web_API_Authentication.Results;

namespace Exemplo_Web_API_Authentication.Controllers
{
    [Authorize]
